 ...
 * 实现页面间事件传递的基类AppCompatActivity
 * <p>
 *     主要负责管理页面间事件监听器的注册及注销，默认该页面支持事件触发
 * </p>
 */
public class EventAppCompatActivity extends AppCompatActivity implements PageEventListener, PageStickEventListener, PageEvent {
    private static final String TAG = "EventAppCompatActivity";
    /**
     * 是否开启页面事件监听，默认不开启
     */
